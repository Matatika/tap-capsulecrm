...
class PartiesStream(CapsulecrmStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("organisation", th.ObjectType(
        ...
        th.Property("phoneNumbers", th.ArrayType(
            th.ObjectType(
                th.Property("id", th.NumberType),
                th.Property("type", th.StringType),
        ...
        th.Property("websites", th.ArrayType(
            th.ObjectType(
                th.Property("id", th.NumberType),
                th.Property("type", th.StringType),
        ...
        th.Property("emailAddresses", th.ArrayType(
            th.ObjectType(
                th.Property("id", th.NumberType),
                th.Property("type", th.StringType),
                th.Property("address", th.StringType),
...
class OpportunitiesStream(CapsulecrmStream):
    ...
    schema = th.PropertiesList(
        ...
        th.Property("party", th.ObjectType(
            th.Property("id", th.NumberType),
            th.Property("username", th.StringType),
            th.Property("name", th.StringType),
        )),
        th.Property("lostReason", th.StringType),
        th.Property("milestone", th.ObjectType(
            th.Property("id", th.NumberType),
            th.Property("name", th.StringType),
        )),
